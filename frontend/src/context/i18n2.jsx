...
const DICT = {
  en: {
    ...
    cannotChangeInGame: 'Cannot change during active game',
    maxTurnsLocked: 'This setting is locked during gameplay. Change it in Game Config before starting a new game.',
    ...
    pauseBody: 'The game is paused. Close to continue playing.',
    resume: 'Resume',
    continueGame: 'Continue',
    restartTitle: 'Restart Game?',
    restartBody: 'This will reset the board and score. Are you sure?',
    restart: 'Restart',
    goalTitle: 'Goal!',
    goalScored: 'Goal scored!',
    youScored: 'You scored a goal! Well played!',
    opponentScored: 'Opponent scored! Let\'s come back!',
    goalMessage: 'A goal has been scored. The match continues.',
    ...
    exit: 'Exit',
    winMessage: 'Great match! Another round?',
    loseMessage: 'Immediate rematch, are you up for it?',
    gameOverMessage: 'The match is over. Play again?',
  },
  es: {
    playNow: 'Jugar Ahora',
    ...
    cannotChangeInGame: 'No se puede cambiar durante el juego',
    maxTurnsLocked: 'Esta configuraci\u00F3n est\u00E1 bloqueada durante el juego. C\u00E1mbiala en Configuraci\u00F3n antes de iniciar una nueva partida.',
    ...
    pauseBody: 'La partida está pausada. Cierra para continuar jugando.',
    resume: 'Reanudar',
    continueGame: 'Continuar',
    restartTitle: '¿Reiniciar partida?',
    restartBody: 'Esto reiniciará el tablero y el marcador. ¿Estás seguro?',
    restart: 'Reiniciar',
    goalTitle: '¡Gol!',
    goalScored: '¡Gol anotado!',
    youScored: '¡Anotaste un gol! ¡Bien jugado!',
    opponentScored: '¡El rival anotó! ¡A remontar!',
    goalMessage: 'Se ha anotado un gol. La partida continúa.',
    gameOverTitle: 'Fin del Juego',
    congratsWin: '¡Felicidades! ¡Ganaste!',
    youLost: '¡Qué lástima! ¡Perdiste!',
    draw: '¡Empate!',
    leftWins: '¡Gana el equipo izquierdo!',
    rightWins: '¡Gana el equipo derecho!',
    playAgain: 'Jugar otra vez',
    exit: 'Salir',
    winMessage: '¡Gran partido! ¿Otra ronda?',
    loseMessage: 'Revancha inmediata, ¿te animas?',
    gameOverMessage: 'La partida ha terminado. ¿Jugar otra vez?',
  }
};
